 ...
 * @version: 
 * @Author: zhaokai
 * @Date: 2020-09-04 21:53:37
 * @LastEditors: zhaokai
 * @LastEditTime: 2020-09-20 20:09:54
 */
#include "log.h"
...
LogEvevtWarp::LogEvevtWarp(LogEvent::ptr e) 
    :m_event(e) {
}

LogEvevtWarp::~LogEvevtWarp() {
    m_event->getLogger()->log(m_event->getLevel(), m_event);
}

std::stringstream& LogEvevtWarp::getSS() {
